...
<form action="edit_1.php" method="POST">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-2">
        <input type="text" name="first_name" class="form-control" maxlength="50" value="<?php echo$row['first_name']; ?>" required> </label>
    </div>

    <div class="row mb-3">
        <label class="col-sm-1 col-form-label"> นามสกุล </label>
        <div class="col-sm-2">
        <input type="text" name="last_name" class="form-control" maxlength="50" value="<?php echo$row['last_name']; ?>" required> </label>
    </div>
    ...
    <div class="row mb-3">
        ...
        <option value="ฝ่ายการผลิต" <?php if ($row['department']=='ฝ่ายการผลิต'){ echo "selected";} ?> >ฝ่ายการผลิต</option>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-2">
        <input type="text" name="age" class="form-control" maxlength="50" value="<?php echo$row['age']; ?>" required> </label>
    </div>
    
    <div class="row mb-3">
        <label class="col-sm-1 col-form-label"> เงินเดือน </label>
        <div class="col-sm-2">
        <input type="text" name="salary" class="form-control" maxlength="50" value="<?php echo$row['salary']; ?>" required> </label>
    </div>
...
<br>
    พัฒนาโดย 664485033 นางสาว กัญญากร จิวรรจนะโรดม  <br>
</head>
